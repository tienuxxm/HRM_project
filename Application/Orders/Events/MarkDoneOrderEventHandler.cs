...
public class MarkDoneOrderEventHandler : INotificationHandler<MarkDoneOrderEvent>
{
    ...
    public MarkDoneOrderEventHandler(IOrderRepository orderRepository,
        ...
        IDateTimeProvider dateTimeProvider, IUnitOfWork unitOfWork, INotificationRepository notificationRepository)
    {
    ...
    public async Task Handle(MarkDoneOrderEvent notification, CancellationToken cancellationToken)
    {
        ...
        var message = $"The Order {order.OrderCode.Value} Completed";
