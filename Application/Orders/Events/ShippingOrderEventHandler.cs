...
public class ShippingOrderEventHandler : INotificationHandler<ShippingOrderEvent>
{
    ...
    public ShippingOrderEventHandler(IOrderRepository orderRepository,
    ...
    public async Task Handle(ShippingOrderEvent notification, CancellationToken cancellationToken)
    {
        ...
        if (string.IsNullOrEmpty(identity))
            return;
        var message = $"Đơn hàng {order.OrderCode.Value} đang được giao";
