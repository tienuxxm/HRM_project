...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260723062259_AddIsAutoApproveToApprovalRouteRule")]
    partial class AddIsAutoApproveToApprovalRouteRule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ApprovalRouting.ApprovalRoutePolicy", b =>
                {
                    ...
                    b.HasIndex("DepartmentId")
                        .IsUnique()
                        .HasDatabaseName("ix_approval_route_policy_department_id")
            ...
            modelBuilder.Entity("Domain.ApprovalRouting.ApprovalRouteRule", b =>
                {
                    ...
                    b.ToTable("approval_route_rule", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.LeaveApproverAssignments.LeaveApproverAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_leave_approver_assignment");

                    b.HasIndex("TargetDepartmentId")
                        .HasDatabaseName("ix_leave_approver_assignment_target_department_id");

                    b.HasIndex("TargetPositionId")
                        .HasDatabaseName("ix_leave_approver_assignment_target_position_id");

                    b.HasIndex("ApproverEmployeeId", "TargetDepartmentId", "TargetPositionId")
                        .HasDatabaseName("ix_leave_approver_assignment_approver_employee_id_target_depar");

                    b.ToTable("leave_approver_assignment", (string)null);
                });

            modelBuilder.Entity("Domain.LeaveBalances.LeaveBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("LeaveTypeId")
                        .HasDatabaseName("ix_leave_balance_leave_type_id");
            ...
            modelBuilder.Entity("Domain.LeaveRequests.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("EmployeeId", "StartDate", "EndDate")
                        .HasDatabaseName("ix_leave_request_employee_id_start_date_end_date");

                    b.ToTable("leave_request", (string)null);
                });

            modelBuilder.Entity("Domain.LeaveTypes.LeaveType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("ix_leave_type_code");
            ...
            modelBuilder.Entity("Domain.MemberVouchers.MemberVoucher", b =>
                {
                    ...
                    b.HasIndex("MemberId1")
                        .HasDatabaseName("ix_member_voucher_member_id1");
            ...
            modelBuilder.Entity("Domain.Members.Member", b =>
                {
                    ...
                    b.Property<DateTime?>("MembershipAssignedDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("membership_assigned_date");
                    ...
                    b.Property<DateTime?>("SendBirthDateNotificationDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("send_birth_date_notification_date");
            ...
            modelBuilder.Entity("Domain.ProductOfRestaurants.ProductOfRestaurant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_of_restaurant");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_product_of_restaurant_product_id");

                    b.HasIndex("RestaurantId")
                        .HasDatabaseName("ix_product_of_restaurant_restaurant_id");

                    b.ToTable("product_of_restaurant", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Provinces.Province", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.RestaurantMenuProducts.RestaurantMenuProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_restaurant_menu_product");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_restaurant_menu_product_product_id");

                    b.HasIndex("RestaurantMenuId")
                        .HasDatabaseName("ix_restaurant_menu_product_restaurant_menu_id");

                    b.ToTable("restaurant_menu_product", (string)null);
                });

            modelBuilder.Entity("Domain.RestaurantMenus.RestaurantMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_restaurant_menu");

                    b.HasIndex("RestaurantId")
                        .HasDatabaseName("ix_restaurant_menu_restaurant_id");

                    b.ToTable("restaurant_menu", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.SystemConfigurations.SystemConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<string>("ConfigJsonValue")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("config_json_value");
            ...
            modelBuilder.Entity("Domain.Vouchers.Voucher", b =>
                {
                    ...
                    b.Property<bool?>("IsUserVoucher")
                        .HasColumnType("boolean")
                        .HasColumnName("is_user_voucher");
                    ...
                    b.Property<int?>("VoucherDefaultType")
                        .HasColumnType("integer")
                        .HasColumnName("voucher_default_type");
            ...
            modelBuilder.Entity("Domain.Wards.Ward", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Domain.Departments.Department", b =>
                {
                    b.HasOne("Domain.Departments.Department", "ParentDepartment")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Districts.District", b =>
                {
                    b.HasOne("Domain.Provinces.Province", "Province")
                        .WithMany("Districts")
                        .HasForeignKey("ProvinceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_district_province_province_temp_id");
            ...
            modelBuilder.Entity("Domain.Employees.Employee", b =>
                {
                    ...
                    b.HasOne("Domain.Employees.Employee", "Manager")
                        .WithMany()
                    ...
                    b.HasOne("Domain.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_employee_user_user_temp_id");
            ...
            modelBuilder.Entity("Domain.LeaveApproverAssignments.LeaveApproverAssignment", b =>
                {
                    b.HasOne("Domain.Employees.Employee", "Approver")
                        .WithMany()
                        .HasForeignKey("ApproverEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_leave_approver_assignment_employee_approver_id");

                    b.HasOne("Domain.Departments.Department", "TargetDepartment")
                        .WithMany()
                        .HasForeignKey("TargetDepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_leave_approver_assignment_department_target_department_id1");

                    b.HasOne("Domain.Positions.Position", "TargetPosition")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.LeaveBalances.LeaveBalance", b =>
                {
                    b.HasOne("Domain.Employees.Employee", "Employee")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_leave_balance_employee_employee_id1");
            ...
            modelBuilder.Entity("Domain.MemberVouchers.MemberVoucher", b =>
                {
                    ...
                    b.HasOne("Domain.Members.Member", null)
                        ...
                        .HasConstraintName("fk_member_voucher_members_member_id1");
            ...
            modelBuilder.Entity("Domain.Members.Member", b =>
                {
                    b.HasOne("Domain.Districts.District", "District")
                        .WithMany()
                        .HasForeignKey("DistrictId")
                        .HasConstraintName("fk_members_district_district_id");
            ...
            modelBuilder.Entity("Domain.Orders.Order", b =>
                {
                    ...
                    b.HasOne("Domain.Members.Member", "Member")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_orders_members_member_id1");
            ...
            modelBuilder.Entity("Domain.ProductOfRestaurants.ProductOfRestaurant", b =>
                {
                    b.HasOne("Domain.Products.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_of_restaurant_products_product_id1");
                    ...
                    b.HasOne("Domain.Restaurants.Restaurant", "Restaurant")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_of_restaurant_restaurant_restaurant_temp_id");
            ...
            modelBuilder.Entity("Domain.RestaurantMenuProducts.RestaurantMenuProduct", b =>
                {
                    b.HasOne("Domain.Products.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_restaurant_menu_product_products_product_id1");

                    b.HasOne("Domain.RestaurantMenus.RestaurantMenu", "RestaurantMenu")
                        .WithMany("MenuProducts")
                        .HasForeignKey("RestaurantMenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_restaurant_menu_product_restaurant_menu_restaurant_menu_temp_id");
            ...
            modelBuilder.Entity("Domain.RestaurantMenus.RestaurantMenu", b =>
                {
                    b.HasOne("Domain.Restaurants.Restaurant", "Restaurant")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_restaurant_menu_restaurant_restaurant_temp_id2");
            ...
            modelBuilder.Entity("Domain.RoleToPermissions.RoleToPermission", b =>
                {
                    ...
                    b.HasOne("Domain.Roles.Role", "Role")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_role_to_permission_role_role_temp_id1");
            ...
            modelBuilder.Entity("Domain.UserToRoles.UserToRole", b =>
                {
                    b.HasOne("Domain.Roles.Role", "Role")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_to_role_role_role_temp_id");
                    ...
                    b.HasOne("Domain.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_to_role_user_user_temp_id1");
            ...
            modelBuilder.Entity("Domain.Wards.Ward", b =>
                {
                    b.HasOne("Domain.Districts.District", "District")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_ward_district_district_temp_id");
